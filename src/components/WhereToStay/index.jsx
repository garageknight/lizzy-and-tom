...
const WhereToStay = () => (
  <Card id="where-to-stay">
    <Content>
      ...
      <Body text="The field is very close by to several towns & villages with Air bnbs, hotels etc. Here are a few as a taster, but we would suggest you do a bit googling to find one that suits your needs." />
